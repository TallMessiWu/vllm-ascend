...
class TestAscendLinearMethodGroupAlign(TestBase):
    ...
    def test_divisible_no_align(self):
        ...
        method.create_weights(
            layer, input_size_per_partition=2048, output_partition_sizes=[512],
            input_size=4096, output_size=512, params_dtype=torch.bfloat16, weight_loader=weight_loader,
        )
    ...
    def test_non_mxfp8_no_align(self):
        ...
        layer = _make_layer(RowParallelLinear, tp_size=2, tp_rank=0, prefix="x")
        method.create_weights(
            layer, input_size_per_partition=2152, output_partition_sizes=[512],
            input_size=4304, output_size=512, params_dtype=torch.bfloat16, weight_loader=weight_loader,
        )
        self.assertIs(layer.weight.weight_loader, weight_loader)
    ...
    def test_tp1_no_align(self):
        ...
        method.create_weights(
            layer, input_size_per_partition=4304, output_partition_sizes=[512],
            input_size=4304, output_size=512, params_dtype=torch.bfloat16, weight_loader=weight_loader,
        )
        self.assertIs(layer.weight.weight_loader, weight_loader)
    ...
    def test_merged_column_no_align(self):
        ...
        method.create_weights(
            layer, input_size_per_partition=512, output_partition_sizes=[2152, 2152],
            input_size=512, output_size=4304, params_dtype=torch.bfloat16, weight_loader=weight_loader,
        )
        self.assertIs(layer.weight.weight_loader, weight_loader)
    ...
    def test_gather_output_no_align(self):
        ...
        method.create_weights(
            layer, input_size_per_partition=512, output_partition_sizes=[2152],
            input_size=512, output_size=4304, params_dtype=torch.bfloat16, weight_loader=weight_loader,
        )
        self.assertIs(layer.weight.weight_loader, weight_loader)
